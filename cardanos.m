function x = cardanos(coef)
    ...
    if (length(coef) ~= 4)
        ...
        if (length(coef) == 3)
            ...
            opts.Default = 'Yes';
            cubic = [num2str(coef(1)) ,'x^3 + ', num2str(coef(2)),...
                        'x + ',num2str(coef(3))];
...
function y= cardanosFomula(p,q)
    ...
    if  delta >= 0
        y1= nthroot((-q/2)+sqrt(((q^2)/4)+((p^3)/27)),3)+...
                nthroot((-q/2)-sqrt(((q^2)/4)+((p^3)/27)),3);

        y2 = ((-1 + sqrt(-3))/2)*nthroot((-q/2)+...
                    sqrt(((q^2)/4)+((p^3)/27)),3)...
                    + ((-1 - sqrt(-3))/2)*nthroot((-q/2)-...
                        sqrt(((q^2)/4)+((p^3)/27)),3);

        y3= ((-1 - sqrt(-3))/2)*nthroot((-q/2)+...
                    sqrt(((q^2)/4)+((p^3)/27)),3)...
                    + ((-1 + sqrt(-3))/2)*nthroot((-q/2)-...
                    sqrt(((q^2)/4)+((p^3)/27)),3);
    else
    
        y1= ((-q/2)+sqrt(((q^2)/4)+((p^3)/27)))^(1/3)+...
            ((-q/2)-sqrt(((q^2)/4)+((p^3)/27)))^(1/3);

        y2 = ((-1 + sqrt(-3))/2)*((-q/2)+...
                    sqrt(((q^2)/4)+((p^3)/27)))^(1/3)...
                    + ((-1 - sqrt(-3))/2)*((-q/2)-...
                    sqrt(((q^2)/4)+((p^3)/27)))^(1/3);
